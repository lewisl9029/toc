System.config({
  ...
  depCache: {
    ...
    "npm:baobab@2.0.0-rc1": [
      "npm:baobab@2.0.0-rc1/dist/baobab"
    ],
    "npm:node-forge@0.6.34": [
      "npm:node-forge@0.6.34/js/forge"
    ],
    "github:driftyco/ionic@1.1.0": [
      "github:driftyco/ionic@1.1.0/release/js/ionic-angular"
    ],
    "npm:ng-cordova@0.1.17-alpha": [
    ...
    "npm:baobab@2.0.0-rc1/dist/baobab": [
      "npm:emmett@3.1.1",
      "npm:baobab@2.0.0-rc1/dist/cursor",
      "npm:baobab@2.0.0-rc1/dist/watcher",
      "npm:baobab@2.0.0-rc1/dist/facet",
      "npm:baobab@2.0.0-rc1/dist/type",
      "npm:baobab@2.0.0-rc1/dist/update",
      "npm:baobab@2.0.0-rc1/dist/helpers"
    ],
    "npm:qr-image@3.1.0/lib/qr": [
    ...
    "github:driftyco/ionic@1.1.0/release/js/ionic-angular": [
      "github:driftyco/ionic@1.1.0/release/js/ionic",
      "github:angular/bower-angular@1.4.5",
    ...
    "github:angular/bower-angular-animate@1.4.5": [
      "github:angular/bower-angular-animate@1.4.5/angular-animate"
    ],
    "github:angular-ui/ui-router@0.2.15": [
      "github:angular-ui/ui-router@0.2.15/angular-ui-router"
    ],
    "github:angular/bower-angular-sanitize@1.4.5": [
      "github:angular/bower-angular-sanitize@1.4.5/angular-sanitize"
    ],
    "github:jspm/nodelibs-stream@0.1.0/index": [
    ...
    "npm:pako@0.2.7/index": [
      "npm:pako@0.2.7/lib/utils/common",
      "npm:pako@0.2.7/lib/deflate",
      "npm:pako@0.2.7/lib/inflate",
      "npm:pako@0.2.7/lib/zlib/constants"
    ],
    "npm:qr-image@3.1.0/lib/crc32buffer": [
      "github:jspm/nodelibs-buffer@0.1.0"
    ],
    ...
    "npm:pako@0.2.7/lib/deflate": [
      "npm:pako@0.2.7/lib/zlib/deflate",
      "npm:pako@0.2.7/lib/utils/common",
      "npm:pako@0.2.7/lib/utils/strings",
      "npm:pako@0.2.7/lib/zlib/messages",
      "npm:pako@0.2.7/lib/zlib/zstream"
    ],
    "npm:pako@0.2.7/lib/inflate": [
      "npm:pako@0.2.7/lib/zlib/inflate",
      "npm:pako@0.2.7/lib/utils/common",
      "npm:pako@0.2.7/lib/utils/strings",
      "npm:pako@0.2.7/lib/zlib/constants",
      "npm:pako@0.2.7/lib/zlib/messages",
      "npm:pako@0.2.7/lib/zlib/zstream",
      "npm:pako@0.2.7/lib/zlib/gzheader"
    ],
    "github:jspm/nodelibs-events@0.1.1": [
    ...
    "npm:pako@0.2.7/lib/zlib/deflate": [
      "npm:pako@0.2.7/lib/utils/common",
      "npm:pako@0.2.7/lib/zlib/trees",
      "npm:pako@0.2.7/lib/zlib/adler32",
      "npm:pako@0.2.7/lib/zlib/crc32",
      "npm:pako@0.2.7/lib/zlib/messages",
      "github:jspm/nodelibs-buffer@0.1.0"
    ],
    "npm:pako@0.2.7/lib/utils/strings": [
    ...
    "npm:pako@0.2.7/lib/zlib/inflate": [
      ...
      "npm:pako@0.2.7/lib/zlib/adler32",
      "npm:pako@0.2.7/lib/zlib/crc32",
      "npm:pako@0.2.7/lib/zlib/inffast",
      "npm:pako@0.2.7/lib/zlib/inftrees",
      "github:jspm/nodelibs-process@0.1.1"
    ],
    "github:jspm/nodelibs-events@0.1.1/index": [
      "npm:events@1.0.2"
