...
var importsVisitor = {
  ImportDeclaration: {
    enter: function enter(node, parent, scope, formatter) {
      ...
      _extend2["default"](formatter.localImports, this.getBindingIdentifiers());
    }
  }
};

var exportsVisitor = _traverse2["default"].explode({
  ExportDeclaration: {
    enter: function enter(node, parent, scope, formatter) {
...
var DefaultFormatter = (function () {
  function DefaultFormatter(file) {
    ...
    this.internalRemap = _object2["default"]();
    this.defaultIds = _object2["default"]();
    this.scope = file.scope;
    this.file = file;
    this.ids = _object2["default"]();
    ...
    this.localExports = _object2["default"]();
    this.localImports = _object2["default"]();
