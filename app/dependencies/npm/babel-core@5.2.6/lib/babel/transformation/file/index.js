...
var File = (function () {
  ...
  File.prototype.parseShebang = function parseShebang(code) {
    var shebangMatch = _shebangRegex2["default"].exec(code);

    if (shebangMatch) {
      this.shebang = shebangMatch[0];

      // remove shebang
      code = code.replace(_shebangRegex2["default"], "");
    }
  ...
  File.prototype.parse = (function (_parse) {
    ...
    return _parse3["default"](parseOpts, code, function (tree) {
      _this.log.debug("Parse stop");
