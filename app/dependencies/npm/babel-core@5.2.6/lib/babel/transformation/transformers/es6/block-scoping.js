...
var BlockScoping = (function () {
  ...
  function BlockScoping(loopPath, blockPath, parent, scope, file) {
    ...
    this.outsideLetReferences = _object2["default"]();
    this.hasLetReferences = false;
    this.letReferences = this.block._letReferences = _object2["default"]();
    this.body = [];
  ...
  BlockScoping.prototype.wrapClosure = function wrapClosure() {
    ...
    var params = _values2["default"](outsideRefs);
    var args = _values2["default"](outsideRefs);
    ...
    // handle generators
    var hasYield = _traverse2["default"].hasType(fn.body, this.scope, "YieldExpression", t.FUNCTION_TYPES);
    if (hasYield) {
      fn.generator = true;
    ...
    var hasAsync = _traverse2["default"].hasType(fn.body, this.scope, "AwaitExpression", t.FUNCTION_TYPES);
    if (hasAsync) {
      fn.async = true;
  ...
  BlockScoping.prototype.getLetReferences = function getLetReferences() {
    ...
    for (var i = 0; i < declarators.length; i++) {
      ...
      _extend2["default"](this.outsideLetReferences, t.getBindingIdentifiers(declar));
    }
    ...
    for (var i = 0; i < declarators.length; i++) {
      ...
      _extend2["default"](this.letReferences, keys);
