  ...
  function convert(nodes) {
    ...
    var _loop = function () {
      ...
      if (t.isExpression(node)) {
        ...
        consequent = node.consequent ? convert([node.consequent]) : t.identifier("undefined");
        alternate = node.alternate ? convert([node.alternate]) : t.identifier("undefined");
...
function toKeyAlias(node) {
  ...
  return (function () {
    ...
    if (t.isIdentifier(key)) {
      ...
      alias = JSON.stringify(_traverse2["default"].removeProperties(t.cloneDeep(key)));
    }
...
function valueToNode(value) {
  ...
  if (value === true || value === false || value === null || _isString2["default"](value) || _isNumber2["default"](value) || _isRegExp2["default"](value)) {
