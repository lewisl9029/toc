    ...
    return function n(t, e, r) {
        ...
        e.exports = function() {
          ...
          p.inherits(e, Error), e.prototype.uncycle = function() {
            ...
            if (!t.__stackCleaned__) {
              ...
              i(u), n(u), t.stack = r(a, u), p.notEnumerableProp(t, "__stackCleaned__", !0);
            }
          ...
          var m,
              j = function() {
                ...
                return "stack" in n || !i ? (d = function(t, e) {
      ...
      23: [function(t, e) {
        ...
        e.exports = function() {
          function e(t) {
            if ("function" != typeof t)
              throw new c("the promise constructor requires a resolver function\n\n    See http://goo.gl/EC22Yn\n");
          ...
          var l = function() {},
              h = {},
              p = {e: null},
              f = t("./thenables.js")(e, l),
              _ = t("./promise_array.js")(e, l, f, o),
              d = t("./captured_trace.js")(),
              v = t("./debuggability.js")(e, d),
              y = t("./context.js")(e, d, v),
              g = t("./catch_filter.js")(p),
              m = t("./promise_resolver.js"),
              j = m._nodebackForPromise,
              b = s.errorObj,
              w = s.tryCatch;
          return e.prototype.toString = function() {
            ...
            if (r > 1) {
              ...
              for (n = 0; r - 1 > n; ++n) {
                ...
                if ("function" != typeof s)
                  return e.reject(new c("Catch filter must inherit from Error or be a simple predicate function\n\n    See http://goo.gl/o84o68\n"));
                i[o++] = s;
              }
            ...
            if (!this._isFollowingOrFulfilledOrRejected()) {
              if (t === this)
                return this._rejectCallback(n(), !1, !0);
              var i = f(t, this);
              if (!(i instanceof e))
            ...
            if (!i._isRejected()) {
              i._pushContext();
              var o;
              if (o = e !== h || this._isRejected() ? w(t).call(e, r) : w(t).apply(this._boundTo, r), i._popContext(), o === b || o === i || o === p) {
                var s = o === i ? n() : o.e;
            ...
            var r = this._promiseAt(t),
                n = r instanceof e;
            if (n && r._isMigrated())
              return r._unsetIsMigrated(), a.invoke(this._settlePromiseAt, this, t);
            ...
            this._clearCallbackDataAtIndex(t), "function" == typeof i ? n ? this._settlePromiseFromHandler(i, u, s, r) : i.call(u, s, r) : u instanceof _ ? u._isResolved() || (this._isFulfilled() ? u._promiseFulfilled(s, r) : u._promiseRejected(s, r)) : n && (this._isFulfilled() ? r._fulfill(s) : r._reject(s, o)), t >= 4 && 4 === (31 & t) && a.invokeLater(this._setLength, this, 0);
      ...
      26: [function(t, e) {
        ...
        e.exports = function(e, r) {
          ...
          function c(t, e, r, n) {
            for (var i = new RegExp(k(e) + "$"),
              ...
              var c = o[s],
                  l = o[s + 1],
                  h = c + e;
              t[h] = n === E ? E(c, p, c, l, e) : n(l, function() {
                return E(c, p, c, l, e);
              });
            }
          ...
          var h,
              ...
              b = /^(?:length|name|arguments|caller|prototype|__isPromisified__)$/,
              w = function(t, e) {
          ...
          e.promisify = function(t, e) {
            ...
            var i = e.promisifier;
            if ("function" != typeof i && (i = E), !f.isIdentifier(r))
      ...
      31: [function(t, e) {
        "use strict";
        var r;
        t("./util.js").isNode ? r = process.nextTick : "undefined" != typeof MutationObserver ? (r = function(t) {
        ...
        function p(t) {
          try {
            if ("function" == typeof t) {
              ...
              return w.isES5 ? e.length > 1 : e.length > 0 && !(1 === e.length && "constructor" === e[0]);
            }
            return !1;
          } catch (r) {
            return !1;
        ...
        var w = t("./es5.js"),
            ...
            P = function() {
              if (w.isES5) {
                ...
                return function(r) {
                  for (var n = [],
                      i = Object.create(null); null != r && r !== t; ) {
                    var o;
                    try {
                      o = e(r);
                    } catch (s) {
